...
export default function DrinksAlcoholic() {
  ...
  const alcoholicBeverages = useSelector(state => state.getDrinksAlcoholic.alcoholicBeverages);
  const isLoading = useSelector(state => state.getDrinksAlcoholic.isLoading);
    ...
    <Container>
      ...
      {isLoading
        ...
        {drinksAlcoholic.map(drink => (
          ...
          <CardButton
            onPress={() => navigation.navigate('DrinkAlcoholic', {
              drink: drink,
            })}
          >
